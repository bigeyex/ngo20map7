...
class TBPage extends Think {
    ...
    protected $rollPage   ;
	// 分页显示定制
    protected $config  =	array('header'=>'条记录','prev'=>'上页','next'=>'下页','first'=>'首页','last'=>'末页','theme'=>' <div class="pager-brief">%totalRow% %header% %nowPage%/%totalPage% 页</div>  <div class="pagination"><ul>%first%  %upPage%  %linkPage%  %downPage% %end%</ul></div>');
